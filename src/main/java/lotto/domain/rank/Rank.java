...
public enum Rank {
    FIRST(6, 2_000_000_000L, "6개 일치", (m, b) -> m == 6),
    SECOND(5, 30_000_000L, "5개 일치, 보너스 볼 일치", (m, b) -> m == 5 && b),
    THIRD(5, 1_500_000L, "5개 일치", (m, b) -> m == 5),
    FOURTH(4, 50_000L, "4개 일치", (m, b) -> m == 4),
    FIFTH(3, 5_000L, "3개 일치", (m, b) -> m == 3),
    MISS(0, 0L, "꽝", (m, b) -> m < 3)
    ;
